...
class PolylineMap extends StatefulWidget {
  final double lat;
  final double lng;
  const PolylineMap(this.lat, this.lng, {super.key});
...
class _PolylineMapState extends State<PolylineMap> {
 ...
 // PolylinePoints polylinePoints = PolylinePoints();
    ...
    return Scaffold(
      body: sourcePosition == null
        ...
        children: [
          ...
          //                 'google.navigation:q=${widget.lat}, ${widget.lng}&key="AIzaSyC06k3KZo8e4eTFBNGlvTbkdehq9l7uB4U"'));
          //           },
          //         ),
          //       ),
          //     ))
  ...
  //       "AIzaSyC06k3KZo8e4eTFBNGlvTbkdehq9l7uB4U",
