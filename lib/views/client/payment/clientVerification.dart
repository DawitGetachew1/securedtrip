...
class _ClientVerificationState extends State<ClientVerification> {
  ...
  void verifyOTP() async {
    ...
    //   Uri.parse(API.verifyOtpClient,), // Replace with your PHP backend URL
    //   body: {'cEmail': widget.userModel.cEmail, 'otp': otpController.text.trim()},
    // );
    //
    // if (response.statusCode == 200) {
    //   Fluttertoast.showToast(msg: "Sign Up successfully");
    //   User userInfo = User.fromJson(widget.userModel.toJson());
    //
    //   print(userInfo);
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                ...
                '\n Below are the bank details needed to complete the payment CBE - 1000252347317 | BOA- 83260262 | TELEBIRR - 0929091180 \n Please send us a screenshot or receipt image of the transaction to this phone number 0902066660 via Telegram.',
