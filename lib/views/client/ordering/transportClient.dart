...
class TransportClient extends StatefulWidget {
   String date;
   String time;
   TransportClient(this.date,this.time);

  @override
  State<TransportClient> createState() => _TransportClientState();
}

class _TransportClientState extends State<TransportClient> {
