...
class TransportSecurity extends StatefulWidget {
  String date;
  String time;
  TransportSecurity(this.date,this.time);

  @override
  State<TransportSecurity> createState() => _TransportSecurityState();
}

class _TransportSecurityState extends State<TransportSecurity> {
  ...
  saveTransportInfo() async {
    ...
    var response = await http.post(
      Uri.parse(API.transportSecurity),
      body: {
        "email": user!.cEmail,
        "date": widget.date,
        "time": widget.time,
