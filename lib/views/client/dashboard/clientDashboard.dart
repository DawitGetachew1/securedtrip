...
import 'package:strong_security/views/client/ordering/ClientOrder.dart';
                             ...
                             child: Column(
                               ...
                               children: [
                                         ...
                                         child: Container(
                                           ...
                                           child: Row(
                                             ...
                                             children: [
                                                 ...
                                                 child: Column(
                                                   ...
                                                   children: [
                                                     Container(
                                                       ...
                                                       margin: EdgeInsets.fromLTRB(3.19*fem, 0*fem, 3.81*fem, 2*fem),
                                                       width: 50*fem,
                                                       height: 28*fem,
                                                       decoration: BoxDecoration (
                                                         borderRadius: BorderRadius.circular(9*fem),
                                               ...
                                               Container(
                                                 // group3279fWX (5:4475)
                                                 margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 34.92*fem, 0*fem),
                                                 width: 70*fem,
                                                 decoration: BoxDecoration (
                                                   borderRadius: BorderRadius.circular(9*fem),
                                                 ),
                                                 child: Column(
                                                   ...
                                                   children: [
                                                     Container(
                                                       ...
                                                       margin: EdgeInsets.fromLTRB(14.19*fem, 1.2*fem, 14.81*fem, 9*fem),
                                                       width: 32*fem,
                                                       height: 28*fem,
                                                       decoration: BoxDecoration (
                                                         borderRadius: BorderRadius.circular(9*fem),
                                                 ...
                                                 child: Column(
                                                   ...
                                                   children: [
                                                     Container(
                                                       ...
                                                       margin: EdgeInsets.fromLTRB(16.27*fem, 1.5*fem, 16.73*fem, 1.5*fem),
                                                       width: 31*fem,
                                                       height: 28*fem,
                                                       decoration: BoxDecoration (
                                                         borderRadius: BorderRadius.circular(9*fem),
                                 ...
                                 Container(
                                   ...
                                   padding: EdgeInsets.fromLTRB(34.23*fem, 10*fem, 33.77*fem, 3*fem),
                                   width: double.infinity,
                                   decoration: const BoxDecoration (
                                     gradient: LinearGradient (
                                       begin: Alignment(1, 1),
                                       end: Alignment(-0.974, -0),
                                       colors: <Color>[Color(0xff428adc), Color(0xffdfeaf8)],
                                       stops: <double>[0, 1],
                                     ),
                                   ),
                                   child: Text(
                                 ...
                                 Container(
                                   margin: EdgeInsets.fromLTRB(95*fem, 20*fem, 0, 20*fem),
                                   child: ElevatedButton(
                                     onPressed: (){
                                       Navigator.push(
                                           context, MaterialPageRoute(
                                           builder: (context)=> const ClientOrder()
                                       ));
                                     },
                                     style:
                                     ButtonStyle(

                                       foregroundColor: getColor(const Color(0xff428adc),const Color(0xffffffff)),
                                       backgroundColor: getColor(const Color(0xffffffff), const Color(0xff428adc)),
                                       side: getBorder(const Color(0xff428adc)),
                                       minimumSize: MaterialStateProperty.all(Size(128*fem, 32*fem)),
                                 ...
                                 Container(
                                   margin: EdgeInsets.fromLTRB(95*fem, 5*fem, 0, 20*fem),
                                   child: ElevatedButton(
                                     onPressed: (){},
                                     style:
                                     ButtonStyle(
                               ...
                               Positioned(
                                   ...
                                   child: Column(
                                     ...
                                     children: [
                                       ...
                                       }, child: Text('CREATE ORDER',style: SafeGoogleFont (
                                         'Poppins',
                                         fontSize: 13*ffem,
