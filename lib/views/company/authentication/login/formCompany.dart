...
class _FormCompanyState extends State<FormCompany> {
  ...
  loginCompanyNow() async {
    try {
      var response = await http.post(
        Uri.parse(API.loginCompany),
        body: {
          "company_email": emailController.text.trim(),
          "company_password": passController.text.trim(),
        },
      );
      ...
      if (response.statusCode == 200) {
        ...
        print(response.body);
        if (resBodyOfLogin['companyData'] != null) {
          Map<String, dynamic> companyData = resBodyOfLogin["companyData"];
          ...
          if (resBodyOfLogin['success'] != null && resBodyOfLogin['success']) {
            ...
            Company companyInfo = Company.fromJson(companyData);
            await RememberCompanyPref.storeCompanyInfo(companyInfo);
              ...
              child: Stack(children: [
                ...
                Positioned(
                    ...
                    child: SizedBox(
                      ...
                      height: 14 * fem,
                      child:
                          Image.asset('images/images/mail-inbox-app-PbV.png'),
                    )),
                Positioned(
                    left: 5 * fem,
                    top: 143 * fem,
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                              minimumSize: Size(120 * fem, 30 * fem)),
                          onPressed: () {
