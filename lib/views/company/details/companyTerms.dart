...
class CompanyTerms extends StatefulWidget {
  final Company companyModel;
  XFile companyProfile;
  final CompanyInf companyInf;
  CompanyTerms(this.companyModel,this.companyProfile,this.companyInf);

  @override
  State<CompanyTerms> createState() => _CompanyTermsState();
}

class _CompanyTermsState extends State<CompanyTerms> {
                    ...
                    onPressed: _isChecked ? () {
                      setState(() {
                        Navigator.push(
                            ...
                            builder: (context)=> CompanyPayemnt(widget.companyModel,widget.companyProfile,widget.companyInf)
                        ));
                      });
