...
class PassTansSec extends StatefulWidget {
  String name;
  String phone;
  String date;
  String time;
  String transType;
  PassTansSec(this.name, this.phone,this.date,this.time,this.transType);

  @override
  State<PassTansSec> createState() => _PassTansSecState();
}

class _PassTansSecState extends State<PassTansSec> {
